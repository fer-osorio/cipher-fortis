 ...
 *
 * Supports all three AES key lengths:
 * - AES-128: 128-bit key
 * - AES-192: 192-bit key
 * - AES-256: 256-bit key
 *
 * All arrays use byte representation in big-endian format.
 * Structure follows the organization pattern from fips197examples.hpp
 */
...
// =============================================================================
// Common Definitions and Base Classes
// =============================================================================
...
size_t ExampleBase::getKeySize() const {
...
// Common plaintext for all examples (64 bytes = 4 blocks)
...
// Keys for different AES variants
...
static const unsigned char* retrieveKey(KeylengthBits kl) {
    switch(kl) {
        ...
        case KeylengthBits::UnknownKeylen: return nullptr;
    }
    return nullptr;
}
...
// ECB Ciphertexts for each key length
const unsigned char ecb_aes128_ciphertext[64] = {
...
const unsigned char ecb_aes192_ciphertext[64] = {
...
const unsigned char ecb_aes256_ciphertext[64] = {
...
static const unsigned char* retrieveECBCiphertext(KeylengthBits kl) {
    switch(kl) {
        case KeylengthBits::keylen128: return ecb_aes128_ciphertext;
        case KeylengthBits::keylen192: return ecb_aes192_ciphertext;
        case KeylengthBits::keylen256: return ecb_aes256_ciphertext;
        case KeylengthBits::UnknownKeylen: return nullptr;
    }
    return nullptr;
}
...
public:
    Example(KeylengthBits kl, OperationType op);
...
Example::Example(KeylengthBits kl, OperationType op) {
    this->keylenbits = kl;
...
OperationType Example::getOperationType() const {
...
const unsigned char cbc_aes128_ciphertext[64] = {
...
const unsigned char cbc_aes192_ciphertext[64] = {
...
const unsigned char cbc_aes256_ciphertext[64] = {
...
static const unsigned char* retrieveCBCCiphertext(KeylengthBits kl) {
    switch(kl) {
        case KeylengthBits::keylen128: return cbc_aes128_ciphertext;
        case KeylengthBits::keylen192: return cbc_aes192_ciphertext;
        case KeylengthBits::keylen256: return cbc_aes256_ciphertext;
        case KeylengthBits::UnknownKeylen: return nullptr;
    }
    return nullptr;
}
...
// =============================================================================
// Utility Functions for Example Creation
// =============================================================================
...
// Helper function to get key length as string
